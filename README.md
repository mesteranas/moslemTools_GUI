# Welcome to Moslem Tools! 🌙📖

Hi everyone!  
I’m thrilled to announce the release of a new program: **Moslem Tools**.  
...
Let me guide you through **installation** and the program’s features.  
...
When you open Moslem Tools, you’ll see the main interface, which includes:  
- A **tab control** containing various tools.  
- A **settings button** for customizing your experience.

Let’s explore the tools available!  
...
#### **Navigation Options**  
Choose how you’d like to browse using the dropdown:  
- Surahs  
- Pages  
- Parts  
- Quarters  
...
3. **Verse Tools**:  
   ...
   - View grammar (`إعراب`) or reasons for revelation (`أساب النزول`).  
...
Access a collection of supplications, such as "أذكار النوم" (sleep prayers).  
