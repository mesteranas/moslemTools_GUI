...
class AthkarSettings(qt.QWidget):
    def __init__(self):
        ...
        self.voiceSelection_laybol=qt.QLabel(_("مدة تشغيل الأذكار الصوتية"))
        ...
        self.textSelection_laybol=qt.QLabel(_("مدة عرض الأذكار النصية"))
        ...
        self.textSelection.setAccessibleName(_("مدة عرض الأذكار النصية"))
