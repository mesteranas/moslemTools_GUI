...
class settings (qt.QDialog):
    def __init__(self,p):
        ...
        self.date_of_publish.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.date_of_publish.setText(_("2 ديسمبر 2024,1 جُمادى الآخِرة 1446"))
        self.date_of_publish.setAccessibleName(_("تاريخ نشر البرنامج"))
        self.date_of_publish_laybol=qt.QLabel(_("تاريخ نشر البرنامج"))
