...
class Albaheth(qt.QWidget):
    def __init__(self):
        ...
        self.ahadeeth_laibol.setAlignment(qt2.Qt.AlignmentFlag.AlignLeft)
        ...
        self.search_layout_top.addWidget(self.serch_laibol, alignment=qt2.Qt.AlignmentFlag.AlignLeft)
    ...
    def OnContextMenu(self):
        ...
        incressFontAction = qt.QAction(_("تكبير الخط"), self)
        ...
        decreaseFontSizeAction = qt.QAction(_("تصغير الخط"), self)
