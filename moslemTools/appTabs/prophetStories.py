...
class ProphetStories(qt.QWidget):
    def __init__(self):
        ...
        layout.addWidget(selectCategoryLabel)
        layout.addWidget(self.selectCategory)
    ...
    def open(self):
        gui.StoryViewer(self,self.stories[self.list_of_aProphetStories.currentItem().text()],self.selectCategory.currentIndex(),self.list_of_aProphetStories.currentItem().text()).exec()
